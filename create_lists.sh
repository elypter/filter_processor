...
./rule_keyword_generator.py https://raw.githubusercontent.com/yourduskquibbles/webannoyances/master/ultralist.txt -ignore_list sources/ignore_keywords.txt  -output_prefix temp/generic_rule_ -min_keyword 3 -min_keyword_score 8
echo "creating generic extraction based filter file:"
./header_filter_creator.py -prefixes temp/generic_rule_prefixes.txt -suffixes temp/generic_rule_suffixes.txt -dprefixes sources/dprefixes.txt -header sources/decoy_generic_extraction_blockhead_header.txt -outfile temp/generic_extraction_blockhead.txt
...
echo "loading ultralist and extracting keywords:"
./rule_keyword_generator.py https://raw.githubusercontent.com/yourduskquibbles/webannoyances/master/ultralist.txt -ignore_list sources/ignore_keywords.txt  -output_prefix temp/generic_rule_plus_ -min_keyword 3 -min_keyword_score 2
echo "creating generic extraction based filter file:"
./header_filter_creator.py -prefixes temp/generic_rule_plus_prefixes.txt -suffixes temp/generic_rule_plus_suffixes.txt -dprefixes sources/dprefixes.txt -header sources/decoy_generic_extraction_blockhead_header.txt -outfile temp/generic_extraction_plus_blockhead.txt
echo "creating decoy generic extraction based filter file:"
